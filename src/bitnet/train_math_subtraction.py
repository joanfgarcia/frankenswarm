...
def run_math_subtraction_arena():
	...
	print(f"⚖️ [Pérdida] Multiplicador para restas: {sub_loss_weight:.2f}x")
	...
	for epoch in range(epochs):
		...
		print(f"🧪 [Test Generalización] Global: {acc_joint_test:.2f}% | ➕ Sumas: {acc_joint_test_sum:.2f}% | ➖ Restas: {acc_joint_test_sub:.2f}%")
