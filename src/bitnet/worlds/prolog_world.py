...
from src.bitnet.worlds.minimal_world import ADJACENCY, LOCATIONS, AgentState, MinimalWorld
...
class PrologSurvivalWorld(MinimalWorld):
	def __init__(self, seed: int = 42):
		...
		self.prolog = Prolog()
		kb_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "kb_supervivencia.pl")
