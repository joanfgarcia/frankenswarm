...
"""
	...
	def alert_replacer(match):
		...
		if "[!" in blockquote:
			return blockquote
		if "miedo" in blockquote.lower() or "riesgo" in blockquote.lower() or "preocup" in blockquote.lower() or "dificil" in blockquote.lower() or "fracaso" in blockquote.lower() or "pesadilla" in blockquote.lower():
			return "> [!WARNING]\n" + blockquote
		elif "lección" in blockquote.lower() or "key" in blockquote.lower() or "clave" in blockquote.lower() or "recomend" in blockquote.lower() or "solución" in blockquote.lower():
			return "> [!IMPORTANT]\n" + blockquote
		else:
			return "> [!NOTE]\n" + blockquote
