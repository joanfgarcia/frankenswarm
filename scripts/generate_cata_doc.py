...
DRAFTS = [
	...
	("forest", "many trees together (collection = group + quantity, DL-017)",
	 "árboles juntos; muchos juntos", ["[G forest tree]", "[G forest much]", "[G forest dark]", "[live animal forest]"], "D"),
	...
	("rain", "water that falls from above", "es agua; se mueve hacia abajo", ["[G rain water]", "[below [move rain]]", "[G rain sky]"], "D"),
	...
	("quiet", "neither spoken nor heard",
	 "no se dice; no se oye", ["[not [G say quiet]]", "[not [G hear quiet]]"], "D"),
	("night", "the quiet dark time", "es oscuro; es un momento; es quiet",
	 ["[dark night]", "[G night moment]", "[G night quiet]"], "D"),
	("moon", "the light in the dark sky", "es de la luz; es del oscuro — la luz de la noche; es del cielo", ["[G moon light]", "[G moon dark]", "[big moon]", "[G moon far]", "[G moon night]", "[G moon sky]"], "D"),
	("star", "a small bright light in the night sky", "es luz; es pequeña; es del cielo", ["[G star light]", "[G star small]", "[G star sky]"], "D"),
	("stone", "a hard thing that does not move by itself",
	 "es cosa; no se mueve", ["[G stone thing]", "[not [move stone]]", "[not [like stone water]]", "[G stone earth]"], "D"),
	("cave", "a dark thing", "es oscuro; es cosa", ["[dark cave]", "[G cave thing]", "[G cave inside]", "[G cave earth]", "[like cave house]"], "D"),
	# ── capa E: acciones ──
	...
	("bed", "the thing one sleeps on, for the night hours", "es cosa; de la familia de dormir; es de la noche", ["[G bed thing]", "[G bed sleep]", "[G bed night]"], "F"),
