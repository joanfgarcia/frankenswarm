...
def run_evaluation(args):
	...
	system_prompt = (
		"Eres la Profesora Samantha, una evaluadora de desarrollo cognitivo infantil. "
		"Tu tarea es evaluar las respuestas de un alumno a una lista de preguntas de examen "
		"y calificar si la respuesta demuestra que tiene la comprensión de la edad cognitiva evaluada. "
		...
		'  "hito_superado": true\n'
		"}\n"
		"La calificación por pregunta debe ser de 0 a 10. "
		"El hito se considera superado (hito_superado: true) si el promedio de calificaciones es igual o superior a 8.0."
	)

	prompt = (
		f"Edad de evaluación cognitiva: {target_age} años.\n\n"
	...
	for idx, qa in enumerate(qa_pairs):
		...
		prompt += f"   Respuesta esperada clásica: \"{qa['expected']}\"\n\n"
